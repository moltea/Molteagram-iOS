                    ...
                    switch item.item {
                        ...
                        case let .video(data, thumbnail, cover, adjustments, caption, asFile, asAnimation, isRound, stickers):
                            ...
                            if !effectiveAsFile {
                                ...
                                if let adjustments = adjustments, !isRound {
                            ...
                            if let price = item.price {
                                ...
                                messages.append(LegacyAssetPickerEnqueueMessage(message: .message(text: text.string, attributes: attributes, inlineStickers: [:], mediaReference: mediaReference, threadId: nil, replyToMessageId: nil, replyToStoryId: nil, localGroupingKey: item.groupedId, correlationId: nil, bubbleUpEmojiOrStickersets: bubbleUpEmojiOrStickersets), uniqueId: item.uniqueId, isFile: effectiveAsFile))
                            }
                    }
                }
            }
