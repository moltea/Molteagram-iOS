...
private func avatarViewLettersImage(size: CGSize, peerId: EnginePeer.Id, letters: [String], isStory: Bool) -> UIImage? {
    ...
    let attributedString = NSAttributedString(string: string, attributes: [NSAttributedString.Key.font: Font.regular(8.0), NSAttributedString.Key.foregroundColor: UIColor.white])
